        ...
        try:
            ...
            if mfg_types:
                ...
                if not profile_nodes:
                    issues_found.append(
                        f"Manufacturing type '{mfg_type.name}' has no profile page attributes"
                    )
                    print(
                        f"   Error: Manufacturing type '{mfg_type.name}' has no profile page attributes"
                    )
                else:
                    print(
                        f"   OK: Manufacturing type '{mfg_type.name}' has {len(profile_nodes)} profile attributes"
                    )
